...
% draw the result
if option ==2
    [resultTemplate resultTarget] = drawResult(originTemplateImage, originTarget2, blockList, labels, blockSize);
elseif option ==1
    [resultTemplate resultTarget] = drawResult(grayTemplateImage, grayTarget2, blockList, labels, blockSize);
end
