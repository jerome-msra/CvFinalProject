...
namespace _geom{
	namespace R3{
		...
		public:
			...
			class vertexiterator : public multyindex<3>{
			private:
				typedef multyindex<3> parent;
			public:
				vertexiterator(){setcount(int3(2,2,2));};
			};
			//____________edgeiterator_____________
			class edgeiterator : public multyindex<3>{
			private:
				typedef multyindex<3> parent;
			...
			//____________edgeiterator_____________
			class faceiterator : public multyindex<2>{
			private:
				typedef multyindex<2> parent;
				typedef intn<3> tindex;
			public:
