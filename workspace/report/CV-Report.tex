...
\section{Minimize Energy Function}
	...
	\subsection{TRW-S}
		\subsubsection{TRW-S}
        \paragraph 
        The tree-reweighted message passing (TRW) techniques, which approach the solution to MRF-LP via a
dual problem defined by a convex combination of trees.
        \paragraph
        Later, a sequential message passing scheme (known as TRW-S)
was proposed. It updates messages in a sequential order instead of a parallel order used in TRW-E and TRW-T, which makes the lower bound will not decrease in TRW-S.
        \paragraph
		...
		\subsubsection{Result}
        In this project, we respect the CVIU 2008's TRW-S code
