...
\section{Minimize Energy Function}
	...
	\subsection{TRW-S}
        ...
        \begin{figure}[!h]
        \centering
        \includegraphics[scale=0.3]{showPlant.jpg}
        \caption{TRW-S Results for the plant image. Top-left: template image; All others: deformed template blocks on target images.}
        \end{figure}
