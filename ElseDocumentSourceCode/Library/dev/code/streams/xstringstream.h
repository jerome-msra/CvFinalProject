...
namespace txt{
	...
	public:
		...
		TextStream & operator<<(long int x);
	...
	*/
	...
	private:
		static const std::ios::openmode mode1(){ return std::ios::out|std::ios::app;};
		static const std::ios::openmode mode2(){ return std::ios::out|std::ios::trunc;};
