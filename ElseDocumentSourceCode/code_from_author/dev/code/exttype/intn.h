...
//______________________________________size_tn___________________________________________
	...
	*/
	...
	typedef intn<3> int3;
	typedef intn<4> int4;
	typedef charn<2> char2;
	typedef charn<3> char3;
	typedef charn<4> char4;
	typedef ucharn<2> uchar2;
	typedef ucharn<3> uchar3;
	typedef ucharn<4> uchar4;
