...
namespace geom{
	namespace R2{
		...
		public:
			Grid(const int2 & size = int2(0,0),double CellSize = 1.0):parent(size,CellSize){};
		public:
		...
		public:
			ObjectGrid(const int2 & size = int2(0,0),double CellSize = 1.0):parent(size,CellSize){
			};
		};
